...
- Added new [`restricted_module_paths` lint](https://kampfkarren.github.io/selene/lints/restricted_module_paths.html) to disallow specified module paths in local assignments and function calls
